...
function printContract2() {
	window.location.href="${base}/contractBorrow/showPdf.do?contractBorrowId=${id}";
}
</script>	
   ...
   <div class="hetong_content">
      ...
      <div class="hetong_contenta02">
         ...
         <ul class="hetong_contenta04">
            ...
            <li class="hetong_contenta06">温馨提示：我就爱车上代收代扣服务仅限于账户资金，不包括代扣因您在我就爱车上进行投资、产生收益而需承担的税费，请您自行向国家税务部门履行缴税义务。
<#-->
               <a>抵押物：房产抵押贷款</a>
               <a>贷款金额：50000.00元</a>  
               <a>目标月利率：14.40%</a>            
 ...
 <div class="hetong_neirong_a01">
    <div class="hetong_neirong_a02">
      <div class="hetong_neirong_xinxi">
         <h3 class="hetong_neirong_xinxibiaoti">${contractBorrow.contractTitle}</h3>
         <div>
           ${contractBorrow.contractContent}
         </div>
      </div>
    </div>
...
<#--      <input type="button" value="PDF格式" class="hetong_neirong_a05" onclick="printContract2();"/>
->
