				...
				<input type="hidden" name="id" value="${loginUser.id}">
					<table class="tableSet" width="100%" border="0" cellspacing="0" cellpadding="0">
		              ...
		              <tr>
		                ...
		                <td>${agencyDb.linkman}</td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">联系人手机：</td>
		                <td>${agencyDb.linkmanMobile}</td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">服务承诺：</td>
		                <td><#if (agencyDb.servicePromise)!>
									<#list agencyDb.servicePromise?split(",") as a> 
		              ...
		              <tr>
		                ...
		                <td>${agencyDb.mainBusiness}</td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">备注：</td>
		                <td>${agencyDb.remark}</td>
		              </tr>
				...
				<input type="hidden" name="id" value="${loginUser.id}">
					<table class="tableSet" width="100%" border="0" cellspacing="0" cellpadding="0">
		              ...
		              <tr>
		                ...
		                <td>${agencyDb.privateCharter}</td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">营业执照图片：</td>
		                <td><a href = "<@imageUrlDecode imgurl="${agencyDb.privateCharterImg}"; imgurl>${imgurl}</@imageUrlDecode>" target = "_blank">查看</a></td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">税务登记号：</td>
		                <td>${agencyDb.taxRegistration}</td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">税务登记证图片：</td>
		                <td><a href = "<@imageUrlDecode imgurl="${agencyDb.privateTaxImg}"; imgurl>${imgurl}</@imageUrlDecode>" target = "_blank">查看</a></td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">机构代码证号：</td>
		                <td>${agencyDb.organization}</td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">机构代码证图片：</td>
		                <td><a href = "<@imageUrlDecode imgurl="${agencyDb.privateOrganizationImg}"; imgurl>${imgurl}</@imageUrlDecode>" target = "_blank">查看</a></td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">开户许可证图片：</td>
		                <td><a href = "<@imageUrlDecode imgurl="${agencyDb.accountLicenceImg}"; imgurl>${imgurl}</@imageUrlDecode>" target = "_blank">查看</a></td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">营业期限：</td>
		                <td>${(agencyDb.businessStart?string("yyyy-MM-dd"))!}-${(agencyDb.businessEnd?string("yyyy-MM-dd"))!}</td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">注册地址：</td>
		                <td>${agencyDb.address}</td>
		              </tr>
	              	<tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">注册资本：</td>
		                <td>${(agencyDb.capital?string.currency)!'￥0.00'}元</td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">风险保证金：</td>
		                <td>${(agencyDb.riskMoney?string.currency)!'￥0.00'}元</td>
		              </tr>
	             	 <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">可担保金额：</td>
		                <td>${(agencyDb.guaranteeMoney?string.currency)!'￥0.00'}元</td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">经营范围：</td>
		                <td>${agencyDb.scope}</td>
		              </tr>
		        	</table> 
        </div>                
    </div>
