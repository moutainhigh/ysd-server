				...
				<form id="agencyForm" method="post" enctype="multipart/form-data">
					<table class="tableSet" width="100%" border="0" cellspacing="0" cellpadding="0">
		              <tr>
		                ...
		                <td>
		                	<input type="hidden" id="vouchers" name="vouchers" value="${(agencyDb.logo)!}"/>
							<input type="file" id="imageFile" name="imageFile" class="kaqu_w100 kaqu_w102">

							<a onclick="ajaxFileUploadImageWithRtn('4', 'imageFile','${base}/file/ajaxUploadImage.do','vouchers',uploadFileHideBack);" id="btnLogo1" href="javascript:void(0);" class="kaqu_e1"></a>
							<a onclick="viewImage('vouchers')" class="kaqu_e2" href="javascript:void(0);"></a>
		                </td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                ...
		                <td>
		                	<input type="hidden" id="vouchers1" name="vouchers"  value="${(agencyDb.logo1)!}"/>
							<input type="file" id="imageFile1" name="imageFile" class="kaqu_w100 kaqu_w102">

							<a onclick="ajaxFileUploadImageWithRtn('4', 'imageFile1','${base}/file/ajaxUploadImage.do','vouchers1',uploadFileHideBack);" id="btnUploadBig" href="javascript:void(0);" class="kaqu_e1"></a>
							<a onclick="viewImage('vouchers1')" class="kaqu_e2" href="javascript:void(0);"></a>
		                </td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                ...
		                <td>
		                	<input type="hidden" id="vouchers2" name="vouchers"  value="${(agencyDb.logo2)!}"/>
							<input type="file" id="imageFile2" name="imageFile" class="kaqu_w100 kaqu_w102">

							<a onclick="ajaxFileUploadImageWithRtn('4', 'imageFile2','${base}/file/ajaxUploadImage.do','vouchers2',uploadFileHideBack);" id="btnUploadBig" href="javascript:void(0);" class="kaqu_e1"></a>
							<a onclick="viewImage('vouchers2')" class="kaqu_e2" href="javascript:void(0);"></a>
		                </td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">公司介绍：</td>
	               		<td><textarea  class="kaqu_w100 " name="agencyDb.introduction" id="introduction" style = "width: 390px; height: 110px;"/>${(agencyDb.introduction)!}</textarea></td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">联系电话：</td>
		                <td>
		                	<input type="text" class="kaqu_w100 " name="agencyDb.subpagePhone" id="subpagePhone" maxlength = "50"  value = "${(agencyDb.subpagePhone)!}"/>
							<label id = "subpagePhone_label" for="agencyDb.subpagePhone"></label>
		                </td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">联系地址：</td>
		                <td><input type="text" class="kaqu_w100 " name="agencyDb.subpageAddress" id="subpageAddress" value = "${(agencyDb.subpageAddress)!}" maxlength = "200"/></td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		                <td class="text_r grayBg" width="86">联系人手机：</td>
		                <td><input type="text" class="kaqu_w100 " name="agencyDb.linkmanMobile" id="" value = "${(agencyDb.linkmanMobile)!}" maxlength = "30"/></td>
		              </tr>
		              <tr>
		                <td class="text_r org grayBg" width="40"></td>
		              ...
		              <tr>	  <td class="text_r org grayBg" width="40"></td>
		                ...
		                <td>
		              			...
		              			<thead>
		              					<tr>
										<td class="kaqu_e6" style = "width:120px">标题</td>
										<td class="kaqu_e6" style = "width:210px">图片</td>
									...
									<tbody id="table_img">
										<#list voucherImgList as vil>
											...
											<tr id="trid_${vil_index}" class="whiteBg">
												...
												<td class="kaqu_e14">
													<a class="kaqu_top" href="javascript:void(0);" onclick="moveUp('${vil_index}')"></a>
													<a class="kaqu_down" href="javascript:void(0);" onclick="moveDown('${vil_index}')"></a>
													<a class="kaqu_close" href="javascript:void(0);" onclick="moveOut('${vil_index}')"></a>
												</td>
											</tr>
										</#list>
									</tbody>
										...
										<#list voucherImgListSj as vil>
											...
											<tr id="trid_sj_${vil_index}" class="whiteBg">
												...
												<td class="kaqu_sd">
													...
													<input type="hidden" id="voucher_sj_${vil_index}" name="vouchersSj" value="<#if v_img! && (v_img?split("="))?size gt 1 > ${v_img?split("=")[1]}</#if>">
												</td>
												<td class="kaqu_sd"><a href="${v_img}" target = "_blank" >查看</a></td>
												<td class="kaqu_e14">
		              ...
		              <tr>
		            	...
		            	<td height="40">
				            ...
				            <input type="reset" class="btn2 ml_15" value="取 消" />
		                </td>
		              </tr>
		              </table>
		              </form>
...
<script type="text/javascript">
	...
	$ok_pt_button.click(function(){
		$.ajax({
				url: qmd.base+"/agency_db/ajaxUpdateSubpageDetail.do",
