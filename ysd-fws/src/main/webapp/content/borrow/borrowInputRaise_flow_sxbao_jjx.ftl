...
<#elseif btp==11>						
							...
							<tr><td class="text_r org grayBg" width="40"></td>
								<td class="text_r grayBg" width="150">稳定型项目编号：</td>
								<td style="">
									<input type="text" value=""  name ="borrow.openBorrow" id="openBorrow" class="input2 w_252"/>
								</td>
							</tr>
							<tr class="contract_param" ><td class="text_r org grayBg" width="40"></td>
								<td class="text_r grayBg" width="150">稳健型担保公司名称：</td>
								<td style="">
									<input type="text" value=""  name ="agencyDbNameSxbaoWjx" id="contract_agencyDbNameSxbaoWjx" class="input2 w_252"/>
								</td>
							</tr>
							<tr class="contract_param" ><td class="text_r org grayBg" width="40"></td>
							...
							<tr class="contract_param" ><td class="text_r org grayBg" width="40"></td>
								<td class="text_r grayBg" >原始借款日期：</td>
								<td style="">
