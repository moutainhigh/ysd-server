       ...
       <div style=" width:350px; margin:0 auto; color:#666; font-size:14px;">
        <table class="tableShadow" width="100%" border="0" cellspacing="1" cellpadding="0">
				...
				<tr height='34' class = "whiteBg">
					...
					<td class="kaqu_xinxi kaqu_xinxi_x2">${(fangkuan.verifyTime?string("yyyy-MM-dd HH:mm:ss"))!}</td>
				</tr>
				<tr height='34' class = "whiteBg">
					<td class="kaqu_fuwu">审核人：</td>
					<td class="kaqu_xinxi kaqu_xinxi_x2">${fangkuan.verifyAdmin}</td>
				</tr>
				<tr height='34' class = "whiteBg">
					<td class="kaqu_fuwu">联系方法：</td>
					<td class="kaqu_xinxi kaqu_xinxi_x2">${fangkuan.verifyPhone}</td>
				</tr>
				<tr height='34' class = "whiteBg">
					<td class="kaqu_fuwu">审核备注：</td>
					<td class="kaqu_xinxi kaqu_xinxi_x2">${fangkuan.verifyRemark}</td>
				</tr>
				</tbody>
		</table>
	</div>
