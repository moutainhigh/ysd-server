...
function checkPieceInput() {
	...
	if ($("#account").val() != ''&&checkMod($("#account").val(),100)==false ) {
		alert("借款金额不能被100整除，请重新输入!");
		return false;
	}
	
	if ($("#account").val() != '') {
		if ($("#wanderPieceSize").val() == '') {
        ...
        <div class="broderShadow">
			...
			<table class="tableSet" width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><input class="input2 w_252" type="text" id = "businessContractCode"  name="borrow.businessContractCode"  value = "" size="35"/>（ 杭保借字第XXX号）</td>
              </tr>
             <#--> <tr>
                <td class="text_r org grayBg"></td>
              ...
              <tr>
                ...
                <td><textarea id="vouchMeasure" name="borrow.vouchMeasure" class="textarea" style="width:400px"></textarea></td>
              </tr> 
         ...
         <h3>项目参数设置</h3>
			...
			<table class="tableSet" width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><input class="input1" type="text" size="35" name="borrow.wanderPieceSize" id="wanderPieceSize" value="${borrow.wanderPieceSize}"  onKeyUp="value=value.replace(/[^0-9.]/g,'')"  onBlur="checkPieceInput()" value=""  />份</td>
              </tr>
              <tr>
                <td class="text_r org grayBg">*</td>
					...
					<select id="lowestAccount" name="borrow.lowestAccount" class="kaqu_r3">
						<@listing_childlist sign="borrow_lowest_wander"; listingList>
							<#list listingList as listing>
								<option value="${listing.keyValue}" >${listing.name}</a></option>
							</#list>
						</@listing_childlist>
					</select>
				</td>
              ...
              <tr>
                ...
                <td>
					<select name="borrow.style" class="kaqu_r3" >
						<option value="3">按期预付息，到期还本</option>
						<option value="4">按期付息，到期还本息</option>
     		...
     		<table class="tableSet" width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
              	<td class="text_r org grayBg"></td>
                <td class="text_r grayBg" width="86">直投用户：</td>
                <td>
					<input type="button" value="新增直投信息" onclick="addDirectItem();" class = "btn3 white">
					<input type="hidden" id="idSortDirect" value="0"/>
					<img src="${base}/static/img/qs.png" width="20" height="20" title="新增直投信息" class="kaqu_e5">
				</td>
              </tr>
              <tr>
              	<td class="text_r org grayBg"></td>
