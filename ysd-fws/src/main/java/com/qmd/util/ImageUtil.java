...
public class ImageUtil {
	...
	public static final String FILE_DIR =  ConstantUtil.IMAGE_UPLOAD_PATH;// 服务器文件绝对路径
...
//	public static final String IMG_DIR = "/var/local/FileImgQmd";// 文件路径
	 ...
	 * @param imageFile 图片文件
	 * @param pathStr 1:身份证上传路径  2:文章图片、首页滚动图片路径 3:标详情图片路径 4:服务商图片路径
	 * @return 图片文件路径    
	 */
...
//		File destImageFile = new File(servletContext.getRealPath(destImagePath));
	...
	//头像上传图片并等比例缩放zoom
	public static String copyImageFile(ServletContext servletContext, File imageFile, int destWidth, int destHeight, String pathStr) {
		if (imageFile == null) {
			return null;
		}
		String formatName = getFormatName(imageFile);
