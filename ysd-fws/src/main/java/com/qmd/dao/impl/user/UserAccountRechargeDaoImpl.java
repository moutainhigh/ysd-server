...
public class UserAccountRechargeDaoImpl extends BaseDaoImpl<UserAccountRecharge,Integer> implements UserAccountRechargeDao {
	...
	@Override
	public List<UserAccountRecharge> getUserAccountRechargeListSum(Map<String, Object> map) {
		List<UserAccountRecharge> userAccountRechargeList =  this.getSqlSession().selectList("UserAccountRecharge.getUserAccountRechargeListSum", map);
		 return userAccountRechargeList;
	}
