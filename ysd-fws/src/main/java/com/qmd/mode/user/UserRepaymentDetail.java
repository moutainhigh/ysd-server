...
public class UserRepaymentDetail implements Serializable {
	...
	private String status; // 还款状态 【0：未还款；1：已还款】
	...
	private String applyContinueTotal;//是否申请续单，如不为0或空，为已申请
	...
	private String waitCapitalNormal;// 待还款本金中的普通资金（还款时，还到可用或者续投中的资金部分)
	private String waitCapitalTaste; // 待还款本金中的体验金
	private String waitCapitalDirect; // 待还款金额中的直投
	
	
	private Integer zqzrStatus;//回款债权转让状态【0：不在转让中；1：成功转让；2：转让中】

	private Integer deferStatus;//还款展期状态-仅对还款本金有效【0：不展期；1：展期成功；】
	...
	public String getWaitCapitalNormal() {
		return waitCapitalNormal;
	}

	public void setWaitCapitalNormal(String waitCapitalNormal) {
		this.waitCapitalNormal = waitCapitalNormal;
	}

	public String getWaitCapitalTaste() {
		return waitCapitalTaste;
	}

	public void setWaitCapitalTaste(String waitCapitalTaste) {
		this.waitCapitalTaste = waitCapitalTaste;
	}

	public String getWaitCapitalDirect() {
		return waitCapitalDirect;
	}

	public void setWaitCapitalDirect(String waitCapitalDirect) {
		this.waitCapitalDirect = waitCapitalDirect;
	}
