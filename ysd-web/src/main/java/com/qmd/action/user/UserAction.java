...
public class UserAction extends BaseAction {
	 ...
	 *  @return
	*/
	@Action(value = "/user/registers", results = { @Result(name = "success", location = "/content/user/register_mobile.ftl", type = "freemarker") })
	 ...
	 *  @return
	 */
	@Action(value = "/user/infoMobile", results = { @Result(name = "success", location = "/content/user/project_info_mobile.ftl", type = "freemarker") })
	 ...
	 *  @return
	 */
	@Action(value = "/user/activitInfo", results = { @Result(name = "success", location = "/content/user/activitInfo.ftl", type = "freemarker") })
	 ...
	 *  @return
	 */
	@Action(value = "/index_model", results = { @Result(name = "success", location = "/content/index_model.html", type = "freemarker") })
