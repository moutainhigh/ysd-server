...
//		  	member_ip= "192.168.1.83";
	...
	public static String RongbaoPayAgain(UserAccountRecharge userRecharge, User user,AccountBank accountBank){
		...
		/*yujian String member_id =user.getId().toString().trim();
...
//		ip = "192.168.1.83";
	...
	public static String RongbaoToPay(String orderNo,String checkCode){
		...
		/*yujian Map<String, String> map = new HashMap<String, String>();
		    map.put("merchant_id", ReapalConfig.merchant_id);
		    map.put("version", ReapalConfig.version);
			map.put("order_no", orderNo);//商户生成的系统订单号
			map.put("check_code", checkCode);//短信验证码
	...
	public static String RongbaoToSelectIsbindCard(Integer userId){
	    ...
	    /*yujian String bank_card_type = "0";//0表示储蓄卡
	 ...
	 */
	public static Map<String,String> buildBank(String order_no, String bind_id, String member_id, String terminal_type) {

		/*yujian Map<String, String> sPara = new HashMap<String, String>();
		...
		try {
			...
			System.out.println("======生成请求卡密form表单=======" + JSON.toJSONString(maps));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return maps;*/
