...
public class ConstantUtil {
	...
	public static final  BigDecimal [][]LIST_QUERY_Rate={
    		...
    		{BigDecimal.ZERO,BigDecimal.valueOf(0.09)},
    		{BigDecimal.valueOf(0.09),BigDecimal.valueOf(0.11)},
    		{BigDecimal.valueOf(0.11),BigDecimal.valueOf(0.13)},
    		{BigDecimal.valueOf(0.13),BigDecimal.valueOf(0.15)},
    		{BigDecimal.valueOf(0.15),BigDecimal.valueOf(4.00)}
    	};
	
	public static final int[][] LIST_QUERY_LIMIT = { { 0, 0 }, { 0, 1 },
			{ 1, 3 }, { 1, 6 }, { 3, 6 }, { 6, 12 }, { 12, 99 } };
...
//	public static final String USER_USERNAME_COOKIE_NAME = "cookieUsername";
	 ...
	 * 查询支付后单子状态
	 */
	public static final String QUERY_PAY_ORDER_NO = "query_pay_order_no";
	/**
	 * 渠道cookie名字
	 */
	public static final String PLACE_COOKIE_NAME ="qudao_cookie";
	/**
	 * 渠道cookie名字
	 */
	public static final Integer PLACE_COOKIE_AGE =5184000;
	/**
	 * Memcached保存用户基本信息名称
	 */
