...
public class BorrowRepaymentDetailDaoImpl extends BaseDaoImpl<BorrowRepaymentDetail,Integer>
	...
	public List<BorrowTemp> getBorrowTempList(Map<String, Object> map){
		List<BorrowTemp> bList= this.getSqlSession().selectList("BorrowRepaymentDetail.getBorrowRepaymentDetailList",map);
		return bList;
	}
