...
public class BorrowDaoImpl extends SqlSessionDaoSupport implements BorrowDaoService {
	...
	public void updateParent(Borrow borrow) {
		this.getSqlSession().update("Borrow.updateParent", borrow);
	}

	@Override
	public void add(Borrow borrow) {
		// TODO Auto-generated method stub
		this.getSqlSession().insert("Borrow.addBor", borrow);
	}
	...
	public List<Borrow> selectListByRongXunFlg(Integer rongXunFlg) {
		// TODO Auto-generated method stub
		
		return this.getSqlSession().selectList("Borrow.selectListByRongXunFlg", rongXunFlg);
	}
