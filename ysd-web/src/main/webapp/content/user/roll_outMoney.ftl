...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>${Application ["qmd.setting.name"]}—国资控股|专业、安全、透明的互联网金融服务平台-我的账户-续投转出页面</title>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
								<tbody>
									...
									<tr>
										...
										<td>
										<#if !user.payPassword>
											<span><strong > <a href="${base}/userCenter/toPayPassword.do" class="red">请点击设置交易密码</a></strong></span>
										<#else>
											<input type="password" name="user.payPassword" id="payPassword" style="width:215px; height:30px; line-height:30px; padding-left:4px; border:1px solid #c6c6c6; border-radius:5px;"> <a style="color:#363636; margin-left:5px;" href="${base}/user/lostpass/usephone.do?p=1">忘记密码？</a>
										</#if>
										</td>
									</tr><tr height="10"><td></td><td></td></tr>
									<tr>
