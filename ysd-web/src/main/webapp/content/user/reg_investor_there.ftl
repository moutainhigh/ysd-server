...
<div class="content">
  ...
  <div style="width:985px; margin:0 auto; margin-top:15px; padding-bottom:15px; clear:both;">
      <div style=" padding:20px 0px 20px 20px; background:url(/static/img/d10.png) 100%  center no-repeat #ffc333; width:965px; height:437px;">
        <div style=" padding:90px 0px 0px 0px; width:375px; height:350px; background:#fff;">
	           ...
	           <div style=" width:375px; text-align:center; margin-top:15px;"><a href="${base}/userCenter/index.do" style="color:#4b4b4b;font-family:'宋体'; text-decoration:underline;">欢迎进入网站</a>&nbsp;&nbsp;<span id="showSecond">3</span>秒后跳转</div>
            ...
            <#--<form id="payPasswordForm" method="post">
		       <ul style=" color:#3e3a39; padding:50px 0px 30px 70px; position:relative; float:left;">
			         ...
			         <font style="color:#807F80; padding-left: 29px;">输入交易密码：</font>
			       ...
			       <li style="color:#595757; font-size:14px;">
			         <font style="color:#807F80;">再次输入交易密码：</font>
