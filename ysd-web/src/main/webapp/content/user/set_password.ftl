...
<head>
<meta charset="utf-8" />
<title>${Application ["qmd.setting.name"]}—国资控股|专业、安全、透明的互联网金融服务平台-重置<#if p==1>安全<#else>登录</#if>密码</title>
  ...
  <div style="width:955px; margin:0 auto; padding-bottom:20px;">
    ...
    <div style="width:955px; float:left; background:#fff; clear:both;">
        ...
        <div style="width:670px; float:right; padding:0px 15px 0px 18px; ">
          ...
          <br/><br/><br/>
          <div class="login user frm" id = "set_password_div">
       ...
       <tr height="18"></tr>
				<tr>
					<td style="width:90px; padding-right:5px; text-align:right;color:#646464;font-family:'宋体';">手机号：</td>
					<td style="color:#646464;font-family:'宋体';"> 
						${(user.phone)!}
					</td>
				</tr>
       <tr height="18"></tr>
				...
				<#else>
					<tr>
						<td style="width:90px; padding-right:5px; text-align:right;color:#646464;font-family:'宋体';">交易密码：</td>
				...
				$.ajax({
					...
					success: function(data) {
						...
						if(data.status=="success"){
							setTimeout(function(){
							alert();
							$("#set_password_div").html('设置成功，<a href="${base}/">返回首页</a>');
							},2000);
						}
					}
				});
