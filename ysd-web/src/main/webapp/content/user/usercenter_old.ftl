...
<div style="width:670px; float:right; padding:20px 15px 10px 18px; ">
      ...
      <div style="padding:14px 0px 20px 0px;">
       ...
       <div style=" width:670px;color:#646464;font-family:'宋体';font-size:14px;font-weight:700; padding-bottom:10px;border-bottom:1px solid #c6c6c6; position:relative;">
          ...
          <ul style="padding-bottom:30px;">
             ...
             <li style=" padding-top:14px;">
               <span style="color:#727171;font-family:'宋体';display:inline-block; width:215px; ">体&nbsp;验&nbsp;金：<font style="color:#be9964;font-family:'宋体';">${(selfaccount.tasteMoney)?string.currency}</font></span>
               
             </li>
             <li style=" padding-top:14px;">
               <span style="color:#727171;font-family:'宋体';display:inline-block; width:215px; ">可用红包：<font style="color:#be9964;font-family:'宋体';">${(selfaccount.awardMoney)?string.currency}</font></span>
         ...
         <#elseif loginUser.typeId==1>
          <ul style="padding-bottom:35px;">
             <li style=" padding-top:14px;">
               <span style="color:#727171;font-family:'宋体';display:inline-block; width:215px; ">待还总额：<font style="color:#be9964;font-family:'宋体';">${(selfaccount.borrowerCollectionCapital+selfaccount.borrowerCollectionInterest)?string.currency}</font></span>
               <span style="color:#727171;font-family:'宋体';display:inline-block; ">待还利息：<font style="color:#be9964;font-family:'宋体';">${(selfaccount.borrowerCollectionInterest)?string.currency}</font></span>
             </li>
             <li style=" padding-top:14px;">
