    ...
    <div style="width:942px; float:right; ">
      <div style="border:1px solid #e6e6e6;background:#fff;">
        <div style=" padding-top:10px; padding-left:10px; padding-bottom:50px; clear:both;">
          <div class="k_right_h1" style="padding-bottom:30px;"><img src="${base}/img/tishi.png"><p>温馨提示:<span style="font-size:14px;">只能有一张银行卡用于提现及在手机端投资哦</span></p></div>
        ...
        <input type="hidden" name="accountBank.id" value="${(accountBank.id)!}">
         <table cellspacing="0" cellpadding="0" border="0" width="100%">
              ...
              <tr>
                ...
                <td>
                  <input  type="text" name="user.realName" id="realName" value="${(loginUser.realName)!}" style="width:294px; height:44px; line-height:44px; padding-left:4px; border:1px solid #e6e6e6; border-radius:5px;color:#4c4c4c; background:#ebebeb;" placeholder="">
                </td>
              </tr>
              <tr height="20"><td></td><td></td></tr>
              <tr>
                ...
                <td>
                  <input type="text" name="user.cardId" value="${loginUser.cardId!}" id="cardId" style="width:294px; height:44px; line-height:44px; padding-left:4px; border:1px solid #e6e6e6; border-radius:5px;color:#4c4c4c; background:#ebebeb;" placeholder="${loginUser.cardId!}">
                </td>
              </tr>
              <tr height="20"><td></td><td></td></tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <input type="text" id="branch" name="accountBank.branch"  value="${(accountBank.branch)!}" style="width:294px; height:44px; line-height:44px; padding-left:4px; border:1px solid #e6e6e6; border-radius:5px;color:#4c4c4c;"  />
                </td>
              </tr>
              <tr height="60">
                <td></td> 
                <td>
                    <input type="submit" value="确认绑定" class="btn_t1" style="display:inline-block;" />
