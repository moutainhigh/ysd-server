        ...
        <div class="register">
            <form id="registerForm_1" >
                <table>
                    ...
                    <tr class="button">
                        <td colspan="2"><input type="button"   onclick="submitForm('1');" value="注册领580元红包"></td>
                    </tr>
                    <tr class="pic">
    ...
    <div class="content_wrap">
        ...
        <div class="new_person">
            <div class="top">
                ...
                <div class="redbag"> 注册即可领取 <span>580元</span></div>
            ...
            <div class="register">
                <form id="registerForm_2">
                    <table>
                        ...
                        <tr class="button">
                            <td colspan="2"><input type="button"   onclick="submitForm('2');" value="注册领580元红包"></td>
                        </tr>
                        <tr class="pic">
