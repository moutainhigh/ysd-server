...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
	<meta charset="utf-8" />
	<title>${Application ["qmd.setting.name"]}—国资控股|专业、安全、透明的互联网金融服务平台-我的账户-红包明细</title>
 ...
 <div style="width:955px; float:left; background:#fff; clear:both;">
	...
	<div style="width:670px; float:right; padding:0px 15px 0px 18px; ">
		...
		<div style=" width:661px;background:#d4d4d4; height:42px; line-height:42px; padding-left:9px; margin-top:8px; float:left;">
           <a href="${base}/spread/toGetLink.do"class="hr">好友推荐</a>
          	...
          	<div style="font-family:'宋体'; color:#000; margin-top:80px; clear:both;">
				...
				<thead bgcolor="#efebdf" align="center">
							<tr height="35">
								...
								<th style="color:#646464;font-family:'宋体'; border-right:1px solid #c6c6c6;border-bottom:1px solid #c6c6c6; font-size:14px;">获得</th>
								<th style="color:#646464;font-family:'宋体'; border-right:1px solid #c6c6c6;border-bottom:1px solid #c6c6c6; font-size:14px;">使用</th>
								<th style="color:#646464;font-family:'宋体'; border-right:1px solid #c6c6c6;border-bottom:1px solid #c6c6c6; font-size:14px;">余额</th>
