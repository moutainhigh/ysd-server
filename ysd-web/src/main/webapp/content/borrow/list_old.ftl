...
<div style="width:970px; margin:0 auto;">
	 ...
	 <ul class="tab">
		...
		<li><a href="javascript:queryList('p',17);" class="tab_list <#if p==17>tab_list_a1</#if>" id="p_17">体验标</a></li>
      </ul>
	...
	<li style="border-bottom:1px dashed #d4d4d4;padding-top:10px; padding-bottom:10px;" class="bluer">
        <span style="background:url(${base}/static/img/b1.png) 0 0 no-repeat; width:69px; height:26p; line-height:26px; text-align:center; color:#ece0b9;font-family:'宋体'; display:inline-block;font-weight:700;">年化利率</span>
			...
			<a href="javascript:queryList('r',1);" <#if r==1>class="bllue"</#if> id="r_1" style="padding-right:40px;">9%以下</a>
			<a href="javascript:queryList('r',2);" <#if r==2>class="bllue"</#if> id="r_2" style="padding-right:40px;">9%-11%</a>
			<a href="javascript:queryList('r',3);" <#if r==3>class="bllue"</#if> id="r_3" style="padding-right:40px;">11%-13%</a>
			<a href="javascript:queryList('r',4);" <#if r==4>class="bllue"</#if> id="r_4" style="padding-right:40px;">13%-15%</a>
			<a href="javascript:queryList('r',5);" <#if r==5>class="bllue"</#if> id="r_5" style="padding-right:40px;">15%以上</a>
	</li>
	...
	<ul style="width:970px; height:43px; line-height:43px;clear:both; float:left; border-bottom:1px solid #c6c6c6;border-top:1px solid #c6c6c6;">
         <li style="float:left; width:125px; padding-left:95px;color:#4b4b4b;font-family:'宋体';font-size:14px;font-weight:bold; ">项目标题</li>
        ...
        <li style="width:235px; float:left;">
	          ...
	          <#if borrow.type==16><img src="${base}/static/img/borrow/xin.png" width="28" height="28" />
	          <#elseif borrow.type==17><img src="${base}/static/img/borrow/ti.png" width="28" height="28" />
	          <#else>
	          	<#if borrow.isVouch==1><img src="${base}/static/img/borrow/zhi.png" width="28" height="28" />
				<#elseif borrow.isVouch==2><img src="${base}/static/img/borrow/di.png" width="28" height="28" />
				<#elseif borrow.isVouch==3><img src="${base}/static/img/borrow/an.png" width="28" height="28" />
				</#if>
			  </#if>
        ...
        <li style="width:140px; float:left;padding-left:23px;"><span style="color:#4b4b4b;font-family:'宋体';font-size:14px;">
		        <#if borrow.funds??>
