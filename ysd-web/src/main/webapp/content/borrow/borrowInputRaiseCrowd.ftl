...
<html>
  <head>
  <title>${Application ["qmd.setting.name"]}—国资控股|专业、安全、透明的互联网金融服务平台-发布项目</title>
	...
	<!-- 上传必备插件 -->
	<script type="text/javascript" src="/static/js/plugin/swfupload/swfupload.js"></script>
	<script type="text/javascript" src="/static/js/plugin/swfupload/swfupload.queue.js"></script>
	<script type="text/javascript" src="/static/js/plugin/swfupload/swfupload.speed.js"></script>
	<script type="text/javascript" src="/static/js/plugin/swfupload/handlers.js"></script>
<!--必要样式-->
<style type="text/css">
/* reset */
...
function setUploadImage(fileInfo) {;
	...
	'<li>'+
		...
		'<div class="p-des">类型：<select style="width:115px;height:27px;border:1px solid #ccc;"  name="vouchersTitle" class="kaqu_r3">'+
		'<option value="1">车辆照片 </option>'+
		'<@listing_childlist sign="xieyi_car_type"; listingList><#list listingList as listing><option value="${listing.description}" >${listing.name}</a></option></#list></@listing_childlist>'+
		'</select></div>'+
...
$().ready(function() {
	var settings = {
		flash_url : "/static/js/plugin/swfupload/swfupload.swf",
		flash9_url : "/static/js/plugin/swfupload/swfupload_fp9.swf",
		upload_url: "/file/sofUpload.do",// 接受上传的地址
		...
		debug: false,
		// Button settings
		button_image_url: "/static/js/plugin/swfupload/upload-btn.png",
		button_width: "143",
		button_height: "45 ",
...
function check_form_promote(){
	...
	if ($("#borrowname").val()=='') {
			...
			alert("校验码不能为空，请重新输入!");
			return false;
		}else if($("#roadHaul").val()==''){
			alert("行驶里程不能为空，请重新输入!");
			return false;
		}else if($("#vin").val()==''){
			alert("车辆识别号不能为空，请重新输入!");
			return false;
		}else if($("#carNum").val()==''){
			alert("车辆编号不能为空，请重新输入!");
			return false;
		}else if($("#engineNumber").val()==''){
			alert("发动机号不能为空，请重新输入!");
			return false;
		}else if($("#use").val()==''){
			alert("用途不能为空，请重新输入!");
			return false;
		}else if($("#modelsLink").val()==''){
			alert("车型链接不能为空，请重新输入!");
			return false;
		}else if($("#sel_brand_id").val()=='请选择'){
			alert("请选择正确的车辆品牌!");
			return false;
		}else if($("#sel_series_id").val()=='请选择'){
			alert("请选择正确的车系!");
			return false;
		}else if($("#carSpec").val()=='请选择'){
			alert("请选择正确的车型!");
			return false;
		}else if($("#onCardTimeYear").val()=='0'){
			alert("请选择正确的上牌年份!");
			return false;
		}else if($("#onCardTimeMonth").val()=='0'){
			alert("请选择正确的上牌月份!");
			return false;
		}else if($("#certificationTimeYear").val()=='0'){
			alert("请选择正确的发证年份!");
			return false;
		}else if($("#certificationTimeMonth").val()=='0'){
			alert("请选择正确的发证月份!");
			return false;
		}
		else{
...
-->
<body onload="checkimg()" class="body_bg">
    ...
    <div style="border:0px solid #c3c3c3;">
		<div class="base_frm" style="padding-top:30px;padding-bottom:30px; background:#fff;">
			...
			<tr>
				...
				<td style=""><input type="text" name="borrow.apr" id="apr"  value="${(borrow.apr)!}" onKeyUp="value=value.replace(/[^0-9.]/g,'')"  onblur="commit_year2month('apr','monthapr');loadRepaymentPlan();"  style="width:284px; height:30px; line-height:30px; padding-left:4px; border:1px solid #c6c6c6; border-radius:5px;"/>
			...
			<tr>
				<td style="width:90px; padding-right:5px; text-align:right;color:#646464;font-family:'宋体';"  >还款计划：</td>
						...
						<tr>
								...
								<td style=""><textarea name="borrow.content" cols="55" rows="6" style="border:1px solid #c6c6c6;border-radius:5px; resize:none;"></textarea></td>
							</tr>
            </table> 
             <#-- -----------------table1 over    -------------------->
         ...
         <h3>车辆基本信息</h3>
			...
			<table >
              ...
              <tr>
                ...
                <td>
                	<input type="text"  name="carInfoJson.vin" id="vin"  style="width:284px; height:30px; line-height:30px; padding-left:4px; border:1px solid #c6c6c6; border-radius:5px;" size="35"/>
                </td>
              </tr> 
              <tr height="10"><td></td><td></td></tr>
              <tr>
                <td class="text_r org grayBg">*</td>
                <td style="width:90px; padding-right:5px; text-align:right;color:#646464;font-family:'宋体';" width="80">车牌编号：</td>
                <td>
                	<input type="text"  name="carInfoJson.carNum" id="carNum" style="width:284px; height:30px; line-height:30px; padding-left:4px; border:1px solid #c6c6c6; border-radius:5px;" size="35"/>
                </td>
              </tr> 
              <tr height="10"><td></td><td></td></tr>
              <tr>
                ...
                <td>
                	<input type="text" name="carInfoJson.engineNumber" id="engineNumber" style="width:284px; height:30px; line-height:30px; padding-left:4px; border:1px solid #c6c6c6; border-radius:5px;" size="35"/>
                </td>
              </tr>
              <tr height="10"><td></td><td></td></tr> 
    <#--
      ...
      -->
              <tr>
                ...
                <td>
                	<input type="text" name="carInfoJson.use" id="use" style="width:284px; height:30px; line-height:30px; padding-left:4px; border:1px solid #c6c6c6; border-radius:5px;" size="35"/>
                </td>
              </tr> 
              <tr height="10"><td></td><td></td></tr>
 <#--             
       ...
       -->           
              <tr>
                ...
                <td>
                	<input type="text" name="carInfoJson.modelsLink"  id="modelsLink" style="width:284px; height:30px; line-height:30px; padding-left:4px; border:1px solid #c6c6c6; border-radius:5px;" size="35" size="35"/>
                </td>
              </tr>
              <tr height="10"><td></td><td></td></tr> 
              <tr>
                <td class="text_r org grayBg"></td>
                <td class="text_r grayBg">上传图片：</td>
                <td>
                <div class="demo">
...
<!--                <input type="button" value="新增凭证" class = "btn3 white" onclick="addImgItem();">
  ...
  -->         	 </tr> 
    	  ...
    	  <h3>安全验证</h3>
			...
			<tr>
                ...
                <td class="text_r grayBg" width="86">交易密码：</td>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" name="mycode" id="mycode" onfocus="verifyCode();"  style="width:284px; height:30px; line-height:30px; padding-left:4px; border:1px solid #c6c6c6; border-radius:5px;" size="35" size="35"/>
