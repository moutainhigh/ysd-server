					...
					<table >
						<tbody>
								...
								<td style="">
									...
									<@listing_childlist sign="borrow_business_type"; listingList>
											<#list listingList as listing>
												<option value="${listing.keyValue}"<#if borrow.isVouch=listing.keyValue> selected="selected"</#if>>${listing.name}</option>
											</#list>
									</@listing_childlist>
								</select>
								</td>
							...
							<tr>
								...
								<td style="">
										<#if borrowType==11||borrowType==14>天标
										<#elseif borrowType==12||borrowType==15>月标
							...
							<tr>
								...
								<td><input style="width:284px; height:30px; line-height:30px; padding-left:4px; border:1px solid #c6c6c6; border-radius:5px;"id = "businessCode" name="borrow.businessCode"value="${borrow.businessCode}" type="text" size="35"/></td>
							</tr><tr height="20"><td></td><td></td></tr>
							<tr>
