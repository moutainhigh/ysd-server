					...
					<table >
						<tbody>
							...
							<tr>
								...
								<td style=""><input type="text" id="borrowname" name="borrow.name" style="width:284px; height:30px; line-height:30px; padding-left:4px; border:1px solid #c6c6c6; border-radius:5px;"/></td>
							</tr><tr height="20"><td></td><td></td></tr>
							<tr>
						...
						<tbody>
							<tr>
								...
								<td style="">
									...
									<input type="checkbox" id="box_parent_flg" name="borrow.parentFlg" value="1" onclick="clkParentFlg();"/>是否拆标&nbsp;&nbsp;&nbsp;
									<span style="display:none;" id="span_pmoney">项目总额：<input type="text" id="pmoney" name="borrow.parentMoney" style="width:94px; height:30px; line-height:30px; padding-left:4px; border:1px solid #c6c6c6; border-radius:5px;" />元</span>
								</td>
							</tr><tr height="20"><td></td><td></td></tr>
							<tr>
							...
							<tr>
								...
								<td style="">
								<input type="checkbox"  name="award2" id="award2" onclick="change_award(2)" value="2" />是否启用还款完成时发放奖励
								</td>
							</tr><tr height="20"><td></td><td></td></tr>
