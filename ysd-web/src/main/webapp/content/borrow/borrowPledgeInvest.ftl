     ...
     <div class="investiputd">
	   <ul ></ul>
        ...
        <div class="bar" style="width: ${borrow.schedule}%;"></div> 
		   ...
		   <li class="cassaddtop"><span class="red">*</span> 交易密码：<input type="password" class="toubiao1" id="payPassword" name="safePassword"> <span><a href="#" class="blue">忘记密码？</a></span></li>
