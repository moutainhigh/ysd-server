var adaptUILayout = (function(){
    ...
    var adapt = function(uiWidth){
        ...
        isxiaomi=ua.indexOf('chrome') > -1;
        isTrue = isiOS || isxiaomi;
        //获取设备信息,并矫正参数值
        ...
        initialContent   = isTrue
            ? 'target-densitydpi=device-dpi, width=' + uiWidth + 'px, user-scalable=no'
            : 'target-densitydpi=' + targetDensitydpi + ', width=' + uiWidth + ', user-scalable=no'+ ', initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0 ';
//        initialContent   = isxiaomi 
//        ? 'target-densitydpi=device-dpi, width=' + uiWidth + 'px, user-scalable=no'
//        : 'target-densitydpi=' + targetDensitydpi + ', width=' + uiWidth + ', user-scalable=no'+ ', initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0 ';
...
adaptUILayout.adapt(750); //适配当前页面