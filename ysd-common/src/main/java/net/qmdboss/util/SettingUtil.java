...
import net.qmdboss.bean.Setting.CommentAuthority;
import net.qmdboss.bean.Setting.CommentDisplayType;
import net.qmdboss.bean.Setting.CurrencyType;
import net.qmdboss.bean.Setting.InstantMessagingPosition;
import net.qmdboss.bean.Setting.LeaveMessageDisplayType;
import net.qmdboss.bean.Setting.Operator;
import net.qmdboss.bean.Setting.RoundType;
import net.qmdboss.bean.Setting.ScoreType;
import net.qmdboss.bean.Setting.StoreFreezeTime;
import net.qmdboss.bean.Setting.WatermarkPosition;
...
public class SettingUtil {
	...
	public static Setting readSetting() throws URISyntaxException, DocumentException, IOException {
		...
		Node imageUploadBasePathNode = document.selectSingleNode("/shopxx/setting/imageUploadBasePath");
		Node imageUploadBasePathMobileNode = document.selectSingleNode("/shopxx/setting/imageUploadBasePathMobile");
		...
		Node shopImgContextNode = document.selectSingleNode("/shopxx/setting/shopImgContext");
		Node shopImgEncodeUrlNode = document.selectSingleNode("/shopxx/setting/shopImgEncodeUrl");
		...
		Node payUrlNode = document.selectSingleNode("/shopxx/setting/payUrl");
		...
		setting.setImageUploadBasePath(imageUploadBasePathNode.getText());
		setting.setImageUploadBasePathMobile(imageUploadBasePathMobileNode.getText());
		...
		setting.setShopImgContext(shopImgContextNode.getText());
		setting.setShopImgEncodeUrl(shopImgEncodeUrlNode.getText());
	...
	public static void writeSetting(Setting setting) {
		...
		if(payUrlNode == null){
			payUrlNode = settingElement.addElement("payUrl");
		}
...
//		String currencyFormat = getCurrencyFormat();
    ...
    public static BigDecimal strToBigDec(String str){
 	   ...
 	   return setPriceScale(BigDecimal.valueOf(Double.valueOf(str)));
