...
//		}
		...
		lastPaymentSnNumber =Long.parseLong( simple.format(new Date()) + getRandomString(5));
		// 退款编号
...
//		lastPaymentSnNumber += PAYMENT_SN_STEP;			yyyyMMddHHmmss
		SimpleDateFormat simple = new SimpleDateFormat("yyyyMMddHHmmss");
		lastPaymentSnNumber = Long.parseLong( simple.format(new Date()) + getRandomString(2));
