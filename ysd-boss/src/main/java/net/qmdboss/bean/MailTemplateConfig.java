...
public class MailTemplateConfig {
	...
	public static final String APPROVE_NOTIFY = "approveNotify";// 认证通知 
	public static final String FULLBORROW_NOTIFY = "fullBorrowNotify";// 满标审核通知
	public static final String WITHDRAW_NOTIFY = "withdrawNotify";// 提现通知 
