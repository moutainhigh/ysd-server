...
import net.qmdboss.bean.GoodsImage;
import net.qmdboss.bean.GoodsParameter;
			...
			for (int i = 0; i < productList.size(); i ++) {
				...
				for (Integer specificationId : specificationIds) {
					for (String specificationValueId : specificationValueIds) {
						SpecificationValue specificationValue = specificationService.getSpecificationValue(specificationId, Integer.parseInt(specificationValueId));
