...
public class DeliveryTemplateDaoImpl extends BaseDaoImpl<DeliveryTemplate, Integer> implements DeliveryTemplateDao {
	...
	public Integer save(DeliveryTemplate deliveryTemplate) {
