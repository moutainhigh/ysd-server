...
import net.qmdboss.entity.Order.PaymentStatus;
import net.qmdboss.entity.Order.ShippingStatus;
	...
	public Integer save(Order order) {
		...
		if (orderItemSet != null) {
			for (OrderItem orderItem : orderItemSet) {
				goodsIdList.add(orderItem.getProduct().getGoods().getId().toString());
			}
		}
