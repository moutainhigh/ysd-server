...
public class DeliveryCenterDaoImpl extends BaseDaoImpl<DeliveryCenter, Integer> implements DeliveryCenterDao {
	...
	public Integer save(DeliveryCenter deliveryCenter) {
