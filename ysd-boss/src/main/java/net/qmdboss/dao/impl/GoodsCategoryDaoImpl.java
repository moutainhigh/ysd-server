...
import net.qmdboss.dao.GoodsCategoryDao;
...
public class GoodsCategoryDaoImpl extends BaseDaoImpl<GoodsCategory, Integer> implements GoodsCategoryDao {
	...
	private void fillGoodsCategory(GoodsCategory goodsCategory) {
		GoodsCategory parent = goodsCategory.getParent();
		if (parent == null) {
			goodsCategory.setPath(goodsCategory.getId().toString());
		} else {
