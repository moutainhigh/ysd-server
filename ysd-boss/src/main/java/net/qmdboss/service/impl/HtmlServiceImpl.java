...
import net.qmdboss.bean.PageTemplateConfig;
import net.qmdboss.common.FreemarkerManager;
import net.qmdboss.dao.ArticleDao;
import net.qmdboss.dao.CommentDao;
import net.qmdboss.dao.GoodsDao;
...
public class HtmlServiceImpl implements HtmlService, ServletContextAware {
	...
	@Transactional(readOnly = true)
	public void buildGoodsContentHtml(Integer id) {
	...
	@Transactional(readOnly = true)
	public void buildCommentGoodsContentHtml(Integer id) {
