...
public class ImageUtil {
	...
	public static final String IMG_DIR = SettingUtil.getSetting().getImageUploadBasePath();//"E:/FileImgQmd";// 文件路径
	public static final String IMG_MOBILE = SettingUtil.getSetting().getImageUploadBasePathMobile();
...
//	public static final String IMG_DIR = "/var/local/FileImgQmd";// 文件路径
	...
	public static String copyImageFile(ServletContext servletContext, File imageFile) {
		...
		System.out.println("393="+destImagePath);
//		File destImageFile = new File(servletContext.getRealPath(destImagePath));
	...
	public static String copyFile(ServletContext servletContext,File file){
		if(file == null){
			return null;
		}
//		String filename = file.getName();
//		String ext = filename.substring(filename.lastIndexOf(".")).toLowerCase();
		String ext = SettingUtil.getSetting().getImageUploadRealPath() + "/" + CommonUtil.getUUID() + ".xls";
		File destFile = new File(IMG_DIR+ext);
