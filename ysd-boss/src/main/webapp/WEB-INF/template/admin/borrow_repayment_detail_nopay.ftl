...
<body class="list">
	<div class="bar">
		还款计划列表&nbsp;总记录数: ${pager.totalCount} (共${pager.pageCount}页)
	</div>
	<div class="body">
		<form id="listForm" action="borrow_repayment_detail!borrowRepaymentNopay.action" method="post">
			<div class="listBar">
				<label>查&nbsp;&nbsp;找: </label>
			...
			<table id="listTable" class="listTable">
				<tr>
					...
					<th>
						<a href="#" class="" name="repaymentDays" hidefocus>保证金</a>
					</th>			
					<th>
						<span>实际需还金额</span>
					</th>
