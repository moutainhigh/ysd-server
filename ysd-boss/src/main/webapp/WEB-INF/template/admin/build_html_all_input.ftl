...
<body class="input">
	...
	<div class="body">
		<form id="inputForm" action="build_html!all.action" method="post">
			...
			<input type="hidden" id="maxResultsInput" name="" class="formText" value="50" />
			<table class="inputTable">
				<tr>
					...
					<td>
						<#--<label><input type="radio" name="buildTypeInput" class="buildTypeInput" value="date"  />指定日期</label>&nbsp;&nbsp;
						<label><input type="radio" name="buildTypeInput" class="buildTypeInput" value="all" checked/>更新所有</label>-->
						后台网站更新
					</td>
				</tr>
				<#--><tr class="dateTr">
