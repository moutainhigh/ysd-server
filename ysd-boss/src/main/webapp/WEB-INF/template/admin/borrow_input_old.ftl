...
<body class="input admin">
	...
	<div class="body">
	  <ul id="tab" class="tab">
		...
		<form id="validateForm" action="borrow!update.action" method="post"  enctype="multipart/form-data">
...
-->				
	...
	<#if borrow.type=='17'>
			...
			<td>
				<input type="text" class="formText" id="borrow_tzxf" name="borrow.tzxf" maxlength="3" onkeyup="value=value.replace(/[^0-9\.]/g,'')"/>&nbsp;元
			</td>
		<tr>
