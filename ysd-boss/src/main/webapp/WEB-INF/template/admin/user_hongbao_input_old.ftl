...
<body class="input admin">
	...
	<div class="body">
		<form id="validateForm" action="user_hongbao!save.action" method="post">
			<table class="inputTable tabContent">
				...
				<tr>
					...
					<td>
						<label><input type="checkbox" name="check1"/>PC</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label><input type="checkbox" name="check2"/>移动</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label><input type="checkbox" name="check3"/>H5</label>
