        ...
        <header data-am-widget="header" class="am-header am-header-default bgc h40 lh40">
		  ...
		  <div class="am-u-md-8 am-u-sm-centered">
		    <form id="pwdForm" class="am-form">
		      <fieldset class="am-form-set" autocomplete="off">
		      	<div class="am-form-group">
		      		<input type="password" name="oldPassword"  placeholder="请输入原登录密码">
		      	</div>
		        <div class="am-form-group">
		      		<input type="password" name = "newPassword" placeholder="请输入8-16位新登录密码">
		      	</div>
		      	<div class="am-form-group">
		      		<input type="password" name="againPassword" placeholder="请再次输入新的登录密码">
		      	</div>
	...
	<script type="text/javascript">
		$(function(){
			...
			$("#pwd_button").click(function(){
					$.ajax({
							url: "${base}/userCenter/updatePwd.do",
