...
<#if borrow.isDxb==1>
				...
				<tr>
					<td class="tar">请输入安全密码：</td>
					<td><input type="password" id="idsafepwd" name="safepwd" style="border:1px solid #c6c6c6;height:30px;line-height:30px;" /></td>
				</tr>
				<tr height="10"></tr>
				<tr height="40">
					<td class="tar">请输入验证码：</td>
					<td>
						<input type="text"  id="mycode" name="mycode" onfocus="verifyCode();" style="border:1px solid #c6c6c6;height:30px;line-height:30px;"/>
