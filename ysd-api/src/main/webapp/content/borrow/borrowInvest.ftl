...
<html>
  <head>
  <title>${Application ["qmd.setting.name"]}-借款人-发布<#if borrow.type==0>秒标<#elseif borrow.type==1>天标<#elseif borrow.type==2>流转标<#elseif borrow.type == 3>信用标</#if></title>
     ...
     <div class="investiputd">
	   <ul ></ul>
        ...
        <div class="bar" style="width: ${borrow.schedule}%;"></div> 
		   ...
		   <li class="cassaddtop"><span class="red">*</span> 安全密码：<input type="password" class="toubiao1" id="payPassword" name="borrowTender.payPassword"> <span><a href="#" class="blue">忘记密码？</a></span></li>
