...
--->
           ...
           <ul style="width:180px; float:left;">
             ...
             <li style="font-size:27px;color:#be9964;">
             	<#if borrow.type == 4>${borrow.apr}%
				<#else><@aprofyear apr="${borrow.apr}"; apryear>${apryear}</@aprofyear>%
				</#if>
			</li>
           </ul>
           <ul style="width:125px; float:left;">
             ...
             <li style="font-size:27px;color:#be9964;">${borrow.timeLimit}<#if borrow.type == 4>个月<#else>天</#if></li>
           </ul>
           ...
           <ul style="width:600px; float:left; padding-bottom:17px; color:#595757;font-family:'宋体';">
             ...
             <li style="width:300px; float:left; padding:15px 0px 0px 0px;">还款方式：<#if borrow.style==1>到期还本息<#elseif borrow.style==2>按月付息到期还本</#if></li>
             ...
             <li style="width:300px; float:left; padding:15px 0px 0px 0px;">奖 励：	
				...
				<#elseif borrow.award==2 >${borrow.funds}%,最后一次还款时发放
				<#else>无</#if>
				</#if>
			</li>
           </ul>
        ...
        <div class="kuang">
                   ...
                   <tbody align="center">
                     <tr height="39">
						...
						<tr>
							...
							<td width="85" style="border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6; background:#f6f6f6;">是否购车：</td>是否逾期：</td>
         ...
         <#if borrow.type==1||borrow.type==4>
                <table width="100%" cellpadding="0" cellspacing="0" style="background:#fff; border:1px solid #c6c6c6; border-right:none;border-bottom:none; color:#646464;font-family:'宋体'; ">
                  ...
                  <tbody align="center">
        <#if borrow.type==1>
				<#list pledgeRepayPlanDetail.pledgeRepayPlanEach as plan>
                    <tr height="40">
                       <td style="border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6; ">${plan.issue}<#if plan_index==0>（募集满立即发放）</#if></td>
                       <td style="border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6; ">${plan.issueTotal}</td>
                       <td style="border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6; ">${plan.issueCapital}</td>
                       <td style="border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6; ">${plan.issueInterest}</td>
                    </tr>
                  </#list>
                    <tr height="40">
                       <td style="border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6; " colspan="1">小计</td>
                       <td style="color:#ff830a;border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6;">￥${pledgeRepayPlanDetail.totalRepay}</td>
                       <td style="border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6; ">￥${pledgeRepayPlanDetail.sumCapital}</td>
                       <td style="border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6; ">￥${pledgeRepayPlanDetail.sumInterest}</td>
                    </tr>
		<#elseif borrow.type==4>
				<#list monthRepayPlanDetail.pledgeRepayPlanEach as plan>
										 <tr height="40">
                       <td style="border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6; ">${plan.issue}<#if plan_index==0>（募集满立即发放）</#if></td>
                       <td style="border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6; ">${plan.issueTotal}</td>
                       <td style="border-bottom:1px solid #c6c6c6;border-right:1px solid #c6c6c6; ">${plan.issueCapital}</td>
     ...
     <div style="width:285px; float:right;padding-top:30px;border-left:1px solid #c6c6c6; ">
       <ul style="padding-left:55px; padding-bottom:65px; ">
          ...
          <li style=" padding-bottom:12px;color:#5c5e60; font-size:14px;font-family:'宋体';">还剩：${borrow.balance}</li>
    <#if showButtonNameFlg==1>
						<input type="button" id="tender" class="lijitouzi" value="${showButtonName}"/>
<#else>
						<input type="button" class="lijitouzi2" value="${showButtonName}"/>
</#if>
