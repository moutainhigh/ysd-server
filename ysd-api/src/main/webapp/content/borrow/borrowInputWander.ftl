...
<html>
  <head>
  <title>${Application ["qmd.setting.name"]}-借款人-发布流转标</title>
...
<!-- right -->
	<div class="admin-con">
		...
		<div class="breadcrumb">
			<a href="${base}/">${Application ["qmd.setting.name"]}</a> &gt;<a href="${base}/userCenter/index.do">我的账户</a>&gt;<a href="${base}/borrow/borrowChoose.do">我要借款</a>&gt; <#if borrow.id==''>新增<#else>修改</#if>流转标借款
		</div>
		<div class="tab clearfix">
			<ul>
				<li><a href="" class="current"><span>流转标借款</span></a></li>
			</ul>		
		</div>
		<div class="tab-con">
	    <form id="wanderForm" name="form1" method="post" action="${base}/borrow/addBorWander.do" onsubmit="return btnWanderSave();" enctype="multipart/form-data" >
	         ...
	         <div class="frm">
				<table width="90%">
                    ...
                    <tr id="testtest0">
						 ...
						 <td><input type="file" id="idFileImage" name="borImagesFile" value="${borrow.borImageFirst}"><!--&nbsp;<input type="button" id="btn_0" value="新增" onclick="addImage('0');"/>--></td>
                     </tr>    
                    <tr>
						  <td class="item">借款金额：</td>
						  <td><input type="text" name="borrow.account"  id="account"  value="${borrow.account}"  onkeyup="value=value.replace(/[^0-9]/g,'')" onBlur="checkPieceInput()"/>  元</td>
                     </tr>  
					 <tr>
                     ...
                     <tr>
						  ...
						  <td><input type="text"  name="borrow.wanderPieceSize" id="wanderPieceSize" value="${borrow.wanderPieceSize}" onKeyUp="value=value.replace(/[^0-9.]/g,'')"  onBlur="checkPieceInput()" /> 份</td>
                      </tr>
					 <tr>
                      ...
                      <tr> 
						 ...
						 <td> <input type="checkbox"  name="award1" id="award1" onclick="change_award();" value="1" class="autoch"> 
						 	是否启用，奖励<input type="text" id="funds" name="borrow.funds" disabled value="" onkeyup="clearNoNum(this)" size="10" />% 
						 	注：此处的奖励是每天的奖励
						 	</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
						  ...
						  <td>
						  	<input type="radio" name="borrow.wanderRedeemTimes" id="redeemTimes1" value="1" checked="checked"/>1次&nbsp;
						  	<input type="radio" name="borrow.wanderRedeemTimes" id="redeemTimes2" value="2" />2次&nbsp;
						  	<input type="radio" name="borrow.wanderRedeemTimes" id="redeemTimes3" value="3" />3次&nbsp;
						  	<input type="radio" name="borrow.wanderRedeemTimes" id="redeemTimes4" value="4" />4次&nbsp;
						  	<input type="radio" name="borrow.wanderRedeemTimes" id="redeemTimes5" value="5" />5次
						  	&nbsp;&nbsp;&nbsp;&nbsp;
