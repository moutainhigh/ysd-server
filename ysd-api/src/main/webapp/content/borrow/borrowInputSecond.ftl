...
<html>
  <head>
  <title>${Application ["qmd.setting.name"]}-借款人-发布秒标</title>
...
//<!--设定定向标-->
function change_d_for_second(type){

	if ($("#isDxb1").attr('checked')=='checked') {
		$("#isDxb").val(1);
...
<div class="admin clearfix">
	...
	<div class="admin-con">
		...
		<div class="breadcrumb">
			<a href="${base}/">${Application ["qmd.setting.name"]}</a> &gt; <a href="${base}/userCenter/index.do">我的账户</a> &gt; <a href="${base}/borrow/borrowChoose.do">我要借款</a> &gt; 秒标借款
	</div>
	...
	<div class="tab-con">
	    <form name="form1" method="post" action="addBorSecond.do"  onsubmit="return check_form();" enctype="multipart/form-data" >
	    	<input type="hidden" name="borrow.award" id="award" value="0" />
	    	<input type="hidden" name="borrow.isDxb" id="isDxb" value="0" />
	    	<input type="hidden" name="borrow.validTime" value="1" />
	        ...
	        <div class="frm">
				<table width="90%">
					...
					<tr >
						  ...
						  <td><input type="text"  name="borrow.apr" id="apr" value="" onkeyup="clearNoNum(this)" onblur="commit(this);" > ‰，年利率为 <font color="#FF0000" id="yearapr">0</font>%</td>
                      </tr>
					 <tr >
                      ...
                      -->
						  <tr > 
						   ...
						   <td> <input type="checkbox"  name="isDxb1" id="isDxb1" onclick="change_d_for_second(1)" value="1" class="autoch"> 是，定向密码为<input type="password" id="pwd" name="borrow.pwd" disabled value="" size="10" /> </td>
                        </tr>
                        <tr>
