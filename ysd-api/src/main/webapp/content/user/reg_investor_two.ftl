...
<head>
	<meta charset="utf-8" />
	<title>${Application ["qmd.setting.name"]}-账户签约</title>
	...
	function sendAuthCode(o){
		if (wait2 ==0) {
		    	...
		    	if(wait2==60){
				    		...
				    		var regPhone =/^(13[0-9]|17[0-9]|18[0-9]|15[0|2|3|6|7|8|9]|18[8|9])\d{8}$/;
...
<div class="content">
  ...
  <div style="width:985px; margin:0 auto; margin-top:15px; padding-bottom:15px; clear:both;">
      <div style=" padding:20px 0px 20px 20px; background:url(/static/img/d9.png) 0 0 no-repeat; width:965px; height:637px;">
