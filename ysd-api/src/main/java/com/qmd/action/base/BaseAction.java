...
public class BaseAction extends ActionSupport {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6758896811404313843L;
...
//	}
	...
	public User getLoginUser() {
		// 首先要从redis里通过token获取user，如果redis出错了，则在catch代码里取从数据库里获取user
		 token = getCookie(User.USER_TOKEN_COOKIE_NAME);
...
//		Map<String,UserInfo> map = (Map<String, UserInfo>) this.getMemcachedByCookie(ConstantUtil.USER_ID_COOKIE_NAME);
//		if(map==null){
//			return null;
//		}
//		UserInfo loginUserInfo = map.get(ConstantUtil.USERINFO_NAME);
//		return loginUserInfo;
//		UserInfo userInfo = (UserInfo) getSession(UserInfo.USER_INFO_ID_SESSION_NAME);
//		if (userInfo == null) {
//			return null;
