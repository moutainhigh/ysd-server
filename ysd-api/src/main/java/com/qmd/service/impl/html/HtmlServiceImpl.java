...
//			return SettingUtil.getSetting().getContextPath();
	...
	public CommonMess buildCommonMess() {
		...
		String officialQq = StringUtils.isEmpty(setting.getOfficialQq())?"":setting.getOfficialQq();
		...
		String copyright = "版权所有&nbsp;"+companyName+"&nbsp;&nbsp;&nbsp;"
				   +"官方QQ群号:"+officialQq+"<br/>"
				   +address+"&nbsp;&nbsp;"
				   +certtext;
//		String copyright = StringUtils.isEmpty(setting.getCerttext())?"":setting.getCerttext();
