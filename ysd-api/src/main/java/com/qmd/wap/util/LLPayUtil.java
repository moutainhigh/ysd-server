...
import com.qmd.wap.web.Md5Algorithm;
import com.qmd.wap.web.SignTypeEnum;
import com.qmd.wap.web.TraderRSAUtil;
    ...
    public static String readReqStr(HttpServletRequest request)
    {
        ...
        try
        {
        	...
        	while(enu.hasMoreElements()){  
	        	...
	        	System.out.println("LLPayUtil--0=="+paraName+": "+request.getParameter(paraName));  
        	}
            ...
            {
                System.out.println("LLPayUtil--1=="+line);
                sb.append(line);
            }
        } catch (IOException e)
        {
