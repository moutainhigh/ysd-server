package com.qmd.wap.security;

import java.io.UnsupportedEncodingException;

/**
 * MD5加密算法
 * keyBean 类实现了RSA Data Security, 
 * Inc.在提交给IETF 的RFC1321中的keyBean message-digest算法。
 * @author shmily
 * @date Dec 31, 2010 5:30:05 PM
 */
public class MD5{
    /*
    ...
    public String getDoubleKey(String inbuf)
    {
        return getkeyBeanofStr(getkeyBeanofStr(inbuf));
    }
    ...
    {
        MD5 m = new MD5();
        System.out.println(m.getkeyBeanofStr(m.getkeyBeanofStr("111111"))
                .toUpperCase());
    }
}
