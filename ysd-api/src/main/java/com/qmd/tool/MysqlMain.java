...
public class MysqlMain {
	...
	public static String package_name_model= "com.qmd.mode.friends";
	public static String save_path = "E:/workspace/jcb/src/main/java/com/qmd/tool/temp";
