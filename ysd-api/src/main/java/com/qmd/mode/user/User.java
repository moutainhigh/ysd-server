...
public class User implements Serializable{
	...
	public static final String USER_PHONE_NUM = "userPhoneNum";// 保存短信手机码的Session名称
	public static final String USER_USERNAME_COOKIE_NAME = "cookieUsername";// 保存登录会员用户名的Cookie名称
	public static final String USER_TOKEN_COOKIE_NAME = "cookieUsertoken";// 保存登录会员token的Cookie名称
...
//---------推广加字段end-------------------
	...
	private String placeName;//渠道、活动名称
