...
public abstract class BasePaymentProduct {
	...
	protected static final String RESULT_URL = "/rest/result";// 支付结果显示URL
	 ...
	 * @return 是否验证通过
	 */
//	public abstract boolean signApi(RechargeConfig rechargeConfig, User user, HttpServletRequest httpServletRequest);
	/**
	 * 根据支付编号获取支付返回信息
	 * 
	 * @param paymentSn
