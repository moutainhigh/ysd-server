...
//	public static String seller_email = "850138237@qq.com";//测试
	...
	// 通知地址，由商户提供
//	public static String notify_url = "http://160836c5u5.iok.la:9999/rest/rbknotify";//测试
	public static String notify_url = ConstantUtil.WEB_SITE+"/rest/rbknotify";//正式 
	
	//卡密认证同步通知地址,由商户提供
//	public static String certify_return_url = "http://160836c5u5.iok.la:9999/rest/rbkmreturn";//测试
	public static String certify_return_url = ConstantUtil.WEB_SITE+"/rest/rbkmreturn";//正式(用来调到支付页面)
	
	//卡密认证异步通知地址,由商户提供
//	public static String certify_notify_url = "http://160836c5u5.iok.la:9999/rest/rbkmnotify";//测试
	public static String certify_notify_url = ConstantUtil.WEB_SITE+"/rest/rbkmnotify";//正式
